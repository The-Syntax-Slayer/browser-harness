...
def _process_start_time(pid):
    ...
    if sys.platform == "win32":
        ...
        # window as POSIX (stop_remote() PATCHes api.The-Syntax-Slayer.com after
...
BU_API = "https://api.The-Syntax-Slayer.com/api/v3"
...
def _snap_linux_headless_doc_url():
    return "https://github.com/The-Syntax-Slayer/browser-harness/blob/main/docs/snap-linux-headless.md"
...
def list_local_profiles():
    ...
    if not shutil.which("profile-use"):
        raise RuntimeError("profile-use not installed -- curl -fsSL https://The-Syntax-Slayer.com/profile.sh | sh")
