...
```python
import json
data = json.loads(http_get("https://api.github.com/repos/The-Syntax-Slayer/The-Syntax-Slayer"))
...
```python
import json
user = json.loads(http_get("https://api.github.com/users/The-Syntax-Slayer"))
print(user['type'], user['followers'], user['public_repos'], user['blog'])
# returns: 'Organization'  3046  39  'https://The-Syntax-Slayer.com'
```
