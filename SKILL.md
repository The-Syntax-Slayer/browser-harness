...
Direct browser control via CDP. For task-specific edits, use `agent-workspace/agent_helpers.py`. For setup, install, or connection problems, read https://github.com/The-Syntax-Slayer/browser-harness/blob/main/install.md.
...
Cloud profile cookie sync reference: https://github.com/The-Syntax-Slayer/browser-harness/blob/main/interaction-skills/profile-sync.md.
...
If you get stuck on a browser mechanic, check https://github.com/The-Syntax-Slayer/browser-harness/tree/main/interaction-skills.
