<img src="https://raw.githubusercontent.com/The-Syntax-Slayer/media/main/browser-harness/banner-ink.svg" alt="Browser Harness" width="100%" />

# browser-harness

[![CI Build](https://github.com/The-Syntax-Slayer/browser-harness/actions/workflows/ci.yml/badge.svg)](https://github.com/The-Syntax-Slayer/browser-harness/actions)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/The-Syntax-Slayer/browser-harness/pulls)
[![Maintained](https://img.shields.io/badge/Maintained%3F-yes-green.svg)](https://github.com/The-Syntax-Slayer/browser-harness/graphs/commit-activity)

Connect an LLM directly to your real browser with a thin, editable CDP harness. For browser tasks where you need **complete freedom**.

One websocket to Chrome, nothing between. The agent writes what's missing during execution. The harness improves itself every run.

Try browser-harness in [Browser Use Cloud](https://cloud.The-Syntax-Slayer.com/v4?utm_campaign=browser-harness-use-in-cloud&utm_source=github) or paste the setup prompt into your coding agent.
...
```text
Install or upgrade browser-harness to the latest stable version with uv using Python 3.12, register the skill from `browser-harness skill`, and connect it to my browser. Follow https://github.com/The-Syntax-Slayer/browser-harness/blob/main/install.md if setup or connection fails.
```
...
- Grab a key at [cloud.The-Syntax-Slayer.com/new-api-key](https://cloud.The-Syntax-Slayer.com/new-api-key)
- Or let the agent sign up itself via [docs.The-Syntax-Slayer.com/llms.txt](https://docs.The-Syntax-Slayer.com/llms.txt) (setup flow + challenge context included).
...
[The Bitter Lesson of Agent Harnesses](https://The-Syntax-Slayer.com/posts/bitter-lesson-agent-harnesses) · [Web Agents That Actually Learn](https://The-Syntax-Slayer.com/posts/web-agents-that-actually-learn)
